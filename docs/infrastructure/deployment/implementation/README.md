...
| S46 | [Primeiro deploy acompanhado de v0.1.1](./slices/S46-primeiro-deploy-acompanhado-v0.1.1.task.md) ([correction-01](./slices/S46-primeiro-deploy-acompanhado-v0.1.1.correction-01.md), [correction-02](./slices/S46-primeiro-deploy-acompanhado-v0.1.1.correction-02.md)) | [Relatório contínuo](./slices/S46-primeiro-deploy-acompanhado-v0.1.1.report.md) | `IN_PROGRESS` — primeiro run falhou em `prepare` por shape REST antigo, sem job deploy ou efeito comercial; correction-02 repara, reconcilia a operação histórica e autoriza uma única execução comercial substituta |
