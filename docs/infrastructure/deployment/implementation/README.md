...
| S44 | [Implantação do control plane deployer na VPS](./slices/S44-implantacao-control-plane-deployer-vps.task.md) ([correction-01](./slices/S44-implantacao-control-plane-deployer-vps.correction-01.md)) | [Relatório contínuo](./slices/S44-implantacao-control-plane-deployer-vps.report.md) | `IN_PROGRESS` — pacote/imagem publicados no SHA `9699214`; retomada autorizada com referência OCI canônica do PostgreSQL amd64 |
