...
| S46 | [Primeiro deploy acompanhado de v0.1.1](./slices/S46-primeiro-deploy-acompanhado-v0.1.1.task.md) | — | `PLANNED` — bootstrap inaugural único, workflow/transporte/CLI canônicos, backup, migrations, sete serviços, HTTPS/JWKS/UI; sem rollback/restore |
