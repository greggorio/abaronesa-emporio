...
| S32 | [Migração da linha Spring para Boot 3.5](./slices/S32-migracao-spring-boot-3-5.task.md) | [Relatório](./slices/S32-migracao-spring-boot-3-5.report.md) | `PLANNED` — grupo A; delegação autorizada após o checkpoint documental |
