...
| S31 | [Remoção dos gerenciadores de pacotes do runtime do whatsapp_service](./slices/S31-remocao-npm-runtime-whatsapp.task.md) ([correction-01](./slices/S31-remocao-npm-runtime-whatsapp.correction-01.md)) | [Relatório](./slices/S31-remocao-npm-runtime-whatsapp.report.md) | `IN_PROGRESS` — execução bloqueada corretamente antes do build; correction-01 autorizada em 01/08/2026 para retomada com BuildKit `linux/amd64` pinado; commit local sem push |
