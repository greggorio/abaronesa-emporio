...
| S31 | [Remoção dos gerenciadores de pacotes do runtime do whatsapp_service](./slices/S31-remocao-npm-runtime-whatsapp.task.md) | — | `PLANNED` — 01/08/2026; contrato refinado e versionado; remediação do grupo B derivada da authorization-01; commit local sem push |
