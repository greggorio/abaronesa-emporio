...
| S30b | [Publicação da primeira release global pelo publisher](./slices/S30b-preflight-publicacao-release-global-publisher.task.md) | [Relatório contínuo](./slices/S30b-preflight-publicacao-release-global-publisher.report.md) | `IN_PROGRESS` — etapa A aceita em 02/08/2026; checks seguros, metadados e authorization-01 pendentes |
