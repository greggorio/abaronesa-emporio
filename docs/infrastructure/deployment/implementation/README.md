...
| S45 | [Prontidão de produção e fechamento do Gate C](./slices/S45-prontidao-producao-gate-c.task.md) | — | `PLANNED` — wiring RS256/deployer, capacidade, configuração protegida, Nginx/TLS e ensaio isolado de backup/restore; sem deploy comercial |
