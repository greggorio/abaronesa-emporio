...
| S30a | [Paridade local e fechamento da CI e do candidato](./slices/S30a-paridade-local-fechamento-ci-candidato.task.md) | [Relatório](./slices/S30a-paridade-local-fechamento-ci-candidato.report.md) | `IN_PROGRESS` — authorization-01 aceita; os nove CVEs residuais foram triados em três grupos de causa (A Spring 6/13, B npm 1/1, C Jasper 2/2) em 01/08/2026; grupo B endereçado pela S31 |
| S31 | [Remoção dos gerenciadores de pacotes do runtime do whatsapp_service](./slices/S31-remocao-npm-runtime-whatsapp.task.md) | — | `PLANNED` — 01/08/2026; remediação do grupo B derivada da authorization-01; commit local sem push |
