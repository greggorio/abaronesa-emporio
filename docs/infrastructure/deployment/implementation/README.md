...
| S34 | [Remoção da atestação nativa indisponível](./slices/S34-remocao-atestacao-nativa-candidato.task.md) ([correction-01](./slices/S34-remocao-atestacao-nativa-candidato.correction-01.md)) | [Relatório](./slices/S34-remocao-atestacao-nativa-candidato.report.md) | `IN_PROGRESS` — implementação preservada; correction-01 fecha dois gates e a semântica dos hashes de publicação |
