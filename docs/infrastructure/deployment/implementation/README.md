...
| S45 | [Prontidão de produção e fechamento do Gate C](./slices/S45-prontidao-producao-gate-c.task.md) ([correction-01](./slices/S45-prontidao-producao-gate-c.correction-01.md)) | [Relatório contínuo](./slices/S45-prontidao-producao-gate-c.report.md) | `IN_PROGRESS` — capacidade/TLS/backup verdes; correction-01 fecha scope e namespace reais, publica `v0.1.1` e mantém deploy em zero |
