...
| S34 | [Remoção da atestação nativa indisponível](./slices/S34-remocao-atestacao-nativa-candidato.task.md) | `—` | `PLANNED` — remover o controle não consumido e preservar a identidade imutável por digest |
