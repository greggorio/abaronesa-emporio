...
| S44 | [Implantação do control plane deployer na VPS](./slices/S44-implantacao-control-plane-deployer-vps.task.md) ([correction-01](./slices/S44-implantacao-control-plane-deployer-vps.correction-01.md), [correction-02](./slices/S44-implantacao-control-plane-deployer-vps.correction-02.md)) | [Relatório contínuo](./slices/S44-implantacao-control-plane-deployer-vps.report.md) | `IN_PROGRESS` — App deployer pronta e VPS revertida; correction-02 autoriza publicar schemas no path runtime `/ops` e concluir o control plane |
