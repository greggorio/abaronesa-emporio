...
const OUTPUT_FILE = `${OUTPUT_DIR}/ui-${new Date().toISOString().replace(/[-:T\.]/g, "").slice(0, 15)}-contas-pagar-pagamento.png`;
...
async function main() {
  ...
  try {
    ...
    console.log("6. Looking for an existing account to pay...");
