...
const OUTPUT_FILE = `${OUTPUT_DIR}/ui-${new Date().toISOString().replace(/[-:T\.]/g, "").slice(0, 15)}-contas-pagar-exclusao-sucesso.png`;
...
async function main() {
  ...
  try {
    ...
    console.log("6. Looking for the last account in the table to delete...");
