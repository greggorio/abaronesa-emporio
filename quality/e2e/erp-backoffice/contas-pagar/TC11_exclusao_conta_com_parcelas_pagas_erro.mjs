...
const OUTPUT_FILE = `${OUTPUT_DIR}/ui-${new Date().toISOString().replace(/[-:T\.]/g, "").slice(0, 15)}-contas-pagar-exclusao-com-parcelas-pagas-erro.png`;
...
async function main() {
  ...
  try {
    ...
    console.log("6. Looking for an account with paid installments to delete...");
