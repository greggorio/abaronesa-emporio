...
const OUTPUT_FILE = `${OUTPUT_DIR}/ui-${new Date().toISOString().replace(/[-:T\.]/g, "").slice(0, 15)}-fornecedor-exclusao-associado-erro.png`;
...
async function main() {
  ...
  try {
    ...
    console.log("6. Looking for a supplier with associated accounts to delete...");
